...
export function NotificationDropdown() {
    ...
    const fetchNotifications = async () => {
        try {
            setLoading(true)
            const response = await axios.get(`${API}/api/notifications/user`, { withCredentials: true })
    ...
    const markAllAsRead = async () => {
        try {
            await axios.patch(`${API}/api/notifications/user/markAllAsRead`, {}, { withCredentials: true })
