                    ...
                    <div className="space-y-8">
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Edit Your Information</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex items-start">
                                        ...
                                        <span>Easily update your personal details, including your name, email, and phone number.</span>
                                    </li>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Change Your Password</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span> Secure your account by creating a strong, unique password.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Update Your Profile Photo</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>Upload a professional, clear headshot to build trust with clients.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
...
{/* Step 4 */}
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Manage Your Portfolio</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span> Add, edit, or remove photos and descriptions of your past work to showcase your skills.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Edit Your Bio</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span> Write a compelling summary of your experience and what you offer.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Set Service Areas</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span> Define the cities or neighborhoods you serve to receive relevant job requests.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Add/Remove Services</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>  Update your service offerings to reflect your current capabilities and specializations.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
