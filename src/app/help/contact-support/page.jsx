                    ...
                    <div className="space-y-8">
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">24/7 Support</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex items-start">
                                        ...
                                        <span>Our support team is available 24 hours a day, 7 days a week to help with any issues you may have.</span>
                                    </li>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Support Portal</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>The fastest way to get help is through our online support portal.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Email Support</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>For less urgent matters, you can send us an email.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Community Forum</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>Find answers to common questions and connect with other professionals in our community forum.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
