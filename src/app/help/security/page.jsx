                    ...
                    <div className="space-y-8">
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Two-Factor Authentication (2FA)</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex items-start">
                                        ...
                                        <span>Enable an extra layer of security that requires a code from your phone in addition to your password.</span>
                                    </li>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Account Activity Log</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>View a history of recent logins and activities on your account.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Report Suspicious Activity</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>Flag any unusual activity or messages to our support team for immediate review.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Secure Payment Processing</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>All payments are handled by a secure, encrypted third-party processor to protect your financial information.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Password Requirements</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>We enforce strong password guidelines to ensure your account is well-protected.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
