                    ...
                    <div className="space-y-8">
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Secure Transactions</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex items-start">
                                        ...
                                        <span>All financial transactions on Alltasko are handled through a trusted third-party payment provider.</span>
                                    </li>
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>This guarantees</span>
                                        </div>
                                        <div className="my-2 ml-6">
                                            <ul className="space-y-2 text-black">
                                                ...
                                                <li className="flex items-start">
                                                    <span className="text-green-700 mr-2">•</span>
                                                    <span>Protection from fraud</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">View Your Earnings</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>Your dashboard includes a dedicated “Earnings” section.</span>
                                        </div>
                                    </li>
                                    ...
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>It allows you to track all income from completed jobs.</span>
                                        </div>
                                    </li>
                                    ...
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>Provides a transparent record of every payment received.</span>
                                        </div>
                                    </li>
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>Ensures you always know where your money stands.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Withdraw Your Funds</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>After a payment is processed and the job is complete:</span>
                                        </div>
                                        <div className="my-2 ml-6">
                                            <ul className="space-y-2 text-black">
                                                <li className="flex items-start">
                                                    <span className="text-green-700 mr-2">•</span>
                                                    <span>Funds will appear in your Alltasko wallet.</span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>You can then</span>
                                        </div>
                                        <div className="my-2 ml-6">
                                            <ul className="space-y-2 text-black">
                                                <li className="flex items-start">
                                                    <span className="text-green-700 mr-2">•</span>
                                                    <span>Link your bank account to the platform</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="text-green-700 mr-2">•</span>
                                                    <span>Transfer your earnings with just a few clicks</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li className="flex flex-col items-start">
                                        <div>
                                        <span className="text-green-700 mr-2">•</span>
                                        <span>No extra fees are charged for withdrawing funds.</span>
                                        </div>
