                    ...
                    <div className="space-y-8">
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Payment Problems</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex items-start">
                                        ...
                                        <span>If a payment fails, double-check your card details and ensure you have sufficient funds.</span>
                                    </li>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Lead Quality</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>If you receive a lead that seems invalid or unresponsive, you may be eligible for a refund. Please refer to the Refunds section for more details.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Account Access</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>If you can't log in, try using the "Forgot Password" feature.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="border-green-200">
                            <CardHeader className="flex flex-row items-start space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-black">Profile Visibility</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>If your profile isn't getting views, make sure it is fully completed and includes a detailed bio and portfolio.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
                            ...
                            <CardContent className="pl-20">
                                <ul className="space-y-2 text-black">
                                    <li className="flex flex-col items-start">
                                        <div>
                                            <span className="text-green-700 mr-2">•</span>
                                            <span>If you're not receiving alerts, check your notification settings and make sure they are enabled.</span>
                                        </div>
                                    </li>
                                </ul>
                            </CardContent>
