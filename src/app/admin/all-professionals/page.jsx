...
export default function ProfessionalsPage() {
  ...
  const [rejectedReason, setRejectedReason] = useState(
    professionals?.reasonOfRejection,
  );
  const limit = 10;
                ...
                <TableBody>
                  {professionals.map((professional) => (
                    <TableRow key={professional._id}>
                      <TableCell>
                        <Link
                          href={`/professional/${professional.name}`}
                          target="_blank"
                        >
                          {professional.name}
                        </Link>
                                ...
                                {isRejectSelected && (
                                  <>
                                    <Input
                                      ...
                                      defaultValue={
                                        professional.reasonOfRejection
                                      }
                                      onChange={(e) => {
                                    ...
                                    <div className=" flex justify-end">
                                      <Button
                                        ...
                                        variant={"ghost"}
                                        className={
                                          "border bg-black text-white cursor-pointer"
                                        }
                                      >
                                        Submit
                                      </Button>
                          ...
                          <DialogContent>
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                ...
                                permanently delete the professional.
                              </DialogDescription>
                            </DialogHeader>
                            <DialogFooter>
                              <Button
